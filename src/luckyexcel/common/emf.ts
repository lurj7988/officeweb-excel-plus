...
UDOC.G = {
    ...
    curveTo: function (gst: any, x1: any, y1: any, x2: any, y2: any, x3: any, y3: any) {
        var p;
...
FromEMF.Parse = function (buff: any, genv: any) {
    ...
    while (true) {
        ...
        else if (fnm == "COMMENT") { //var ds = rU32(buff, loff); 
            loff += 4;
        }
        ...
        else if (fnm == "SETSTRETCHBLTMODE") { //var sm = rU32(buff, loff); 
            loff += 4;
        }
...
export let ToContext2D: any = function (this: any, needPage: any, scale: any) {
...
ToContext2D.prototype.Fill = function (gst: any, _evenOdd: any) {
    if (this.currPage != this.needPage) return;
    var ctx = this.ctx;
    ctx.beginPath();
...
ToContext2D.prototype.PutText = function (gst: any, str: any, _stw: any) {
    if (this.currPage != this.needPage) return;
