...
export class LuckySheetCelldata extends LuckySheetCelldataBase {
    ...
    constructor(cell: Element, styles: IStyleCollections, sharedStrings: Element[], _mergeCells: Element[], _sheetFile: string, _ReadXml: ReadXml) {
        //Private
        super();
        this.cell = cell;
    ...
    */
                    ...
                    rFlag.forEach((r) => {
                        ...
                        if (rPr != null && rPr.length > 0) {
                            ...
                            let sz = getlineStringAttr(frpr, "sz"),
                                ...
                                vertAlign = getlineStringAttr(frpr, "vertAlign"), color;
    ...
    private getBackgroundByFill(fill: Element, _clrScheme: Element[]): string | null {
    ...
    private htmlDecode(str: string): string {
        return str.replace(/&#(x)?([^&]{1,5});/g, function (_$, $1, $2) {
